...
class CodemirrorAsset extends \yii\web\AssetBundle
{
	...
	const ADDON_COMMENT_COMMENT = 'COMMENT_COMMENT';
	const ADDON_COMMENT_CONTINUECOMMENT = 'COMMENT_CONTINUECOMMENT';
	const ADDON_DIALOG_DIALOG = 'DIALOG_DIALOG';
	const ADDON_DISPLAY_FULLSCREEN = 'DISPLAY_FULLSCREEN';
	const ADDON_DISPLAY_PANEL = 'DISPLAY_PANEL';
	const ADDON_DISPLAY_PLACEHOLDER = 'DISPLAY_PLACEHOLDER';
	const ADDON_DISPLAY_RULERS = 'DISPLAY_RULERS';
	const ADDON_EDIT_CLOSEBRACKETS = 'EDIT_CLOSEBRACKETS';
	const ADDON_EDIT_CLOSETAG = 'EDIT_CLOSETAG';
	const ADDON_EDIT_CONTINUELIST = 'EDIT_CONTINUELIST';
	const ADDON_EDIT_MATCHBRACKETS = 'EDIT_MATCHBRACKETS';
	const ADDON_EDIT_MATCHTAGS = 'EDIT_MATCHTAGS';
	const ADDON_EDIT_TRAILINGSPACE = 'EDIT_TRAILINGSPACE';
	const ADDON_FOLD_BRACE_FOLD = 'FOLD_BRACE_FOLD';
	const ADDON_FOLD_COMMENT_FOLD = 'FOLD_COMMENT_FOLD';
	const ADDON_FOLD_FOLDCODE = 'FOLD_FOLDCODE';
	const ADDON_FOLD_FOLDGUTTER = 'FOLD_FOLDGUTTER';
	const ADDON_FOLD_INDENT_FOLD = 'FOLD_INDENT_FOLD';
	const ADDON_FOLD_MARKDOWN_FOLD = 'FOLD_MARKDOWN_FOLD';
	const ADDON_FOLD_XML_FOLD = 'FOLD_XML_FOLD';
	const ADDON_HINT_ANYWORD_HINT = 'HINT_ANYWORD_HINT';
	const ADDON_HINT_CSS_HINT = 'HINT_CSS_HINT';
	const ADDON_HINT_HTML_HINT = 'HINT_HTML_HINT';
	const ADDON_HINT_JAVASCRIPT_HINT = 'HINT_JAVASCRIPT_HINT';
	const ADDON_HINT_SHOW_HINT = 'HINT_SHOW_HINT';
	const ADDON_HINT_SQL_HINT = 'HINT_SQL_HINT';
	const ADDON_HINT_XML_HINT = 'HINT_XML_HINT';
	const ADDON_LINT_COFFEESCRIPT_LINT = 'LINT_COFFEESCRIPT_LINT';
	const ADDON_LINT_CSS_LINT = 'LINT_CSS_LINT';
	const ADDON_LINT_JAVASCRIPT_LINT = 'LINT_JAVASCRIPT_LINT';
	const ADDON_LINT_JSON_LINT = 'LINT_JSON_LINT';
	const ADDON_LINT_LINT = 'LINT_LINT';
	const ADDON_LINT_YAML_LINT = 'LINT_YAML_LINT';
	const ADDON_MERGE_MERGE = 'MERGE_MERGE';
	const ADDON_MODE_LOADMODE = 'MODE_LOADMODE';
	const ADDON_MODE_MULTIPLEX = 'MODE_MULTIPLEX';
	const ADDON_MODE_OVERLAY = 'MODE_OVERLAY';
	const ADDON_MODE_SIMPLE = 'MODE_SIMPLE';
	const ADDON_RUNMODE_COLORIZE = 'RUNMODE_COLORIZE';
	const ADDON_RUNMODE_RUNMODE_STANDALONE = 'RUNMODE_RUNMODE_STANDALONE';
	const ADDON_RUNMODE_RUNMODE = 'RUNMODE_RUNMODE';
	const ADDON_RUNMODE_RUNMODE_NODE = 'RUNMODE_RUNMODE_NODE';
	const ADDON_SCROLL_ANNOTATESCROLLBAR = 'SCROLL_ANNOTATESCROLLBAR';
	const ADDON_SCROLL_SCROLLPASTEND = 'SCROLL_SCROLLPASTEND';
	const ADDON_SCROLL_SIMPLESCROLLBARS = 'SCROLL_SIMPLESCROLLBARS';
	const ADDON_SEARCH_MATCH_HIGHLIGHTER = 'SEARCH_MATCH_HIGHLIGHTER';
	const ADDON_SEARCH_MATCHESONSCROLLBAR = 'SEARCH_MATCHESONSCROLLBAR';
	const ADDON_SEARCH_SEARCH = 'SEARCH_SEARCH';
	const ADDON_SEARCH_SEARCHCURSOR = 'SEARCH_SEARCHCURSOR';
	const ADDON_SELECTION_ACTIVE_LINE = 'SELECTION_ACTIVE_LINE';
	const ADDON_SELECTION_MARK_SELECTION = 'SELECTION_MARK_SELECTION';
	const ADDON_SELECTION_SELECTION_POINTER = 'SELECTION_SELECTION_POINTER';
	const ADDON_TERN_TERN = 'TERN_TERN';
	const ADDON_TERN_WORKER = 'TERN_WORKER';
	const ADDON_WRAP_HARDWRAP = 'WRAP_HARDWRAP';
	...
	private static $_css=[
		...
		self::THEME_NEAT => 'theme\neat.css',
		self::THEME_NEO => 'theme\neo.css',
		self::THEME_NIGHT => 'theme\night.css',
		...
		self::THEME_THE_MATRIX => 'theme\the-matrix.css',
		self::THEME_TOMORROW_NIGHT_BRIGHT => 'theme\tomorrow-night-bright.css',
		self::THEME_TOMORROW_NIGHT_EIGHTIES => 'theme\tomorrow-night-eighties.css',
		self::THEME_TWILIGHT => 'theme\twilight.css',
		...
		self::ADDON_DIALOG_DIALOG => 'addon\dialog\dialog.css',
		...
		self::ADDON_LINT_LINT => 'addon\lint\lint.css',
		self::ADDON_MERGE_MERGE => 'addon\merge\merge.css',
		...
		self::ADDON_TERN_TERN => 'addon\tern\tern.css',
		
		self::MODE_TIDDLYWIKI => 'mode\tiddlywiki\tiddlywiki.css',
		self::MODE_TIKI	=> 'mode\tiki\tiki.css',
	];
	...
	private static $_js=[
		...
		self::ADDON_COMMENT_COMMENT => 'addon\comment\comment.js',
		self::ADDON_COMMENT_CONTINUECOMMENT => 'addon\comment\continuecomment.js',
		self::ADDON_DIALOG_DIALOG => 'addon\dialog\dialog.js',
		self::ADDON_DISPLAY_FULLSCREEN =>'addon\display\fullscreen.css', 
		...
		self::ADDON_EDIT_TRAILINGSPACE => 'addon\edit\trailingspace.js',
		...
		self::ADDON_LINT_LINT => 'addon\lint\lint.js',
		self::ADDON_LINT_YAML_LINT => 'addon\lint\yaml-lint.js',
		self::ADDON_MERGE_MERGE => 'addon\merge\merge.js',
		...
		self::ADDON_RUNMODE_RUNMODE_STANDALONE => 'addon\runmode\runmode-standalone.js',
		self::ADDON_RUNMODE_RUNMODE => 'addon\runmode\runmode.js',
		self::ADDON_RUNMODE_RUNMODE_NODE => 'addon\runmode\runmode.node.js',
		...
		self::ADDON_SEARCH_SEARCH => 'addon\search\search.js',
		self::ADDON_SEARCH_SEARCHCURSOR => 'addon\search\searchcursor.js',
		...
		self::ADDON_SELECTION_SELECTION_POINTER => 'addon\selection\selection-pointer.js',
		self::ADDON_TERN_TERN => 'addon\tern\tern.js',
		self::ADDON_TERN_WORKER => 'addon\tern\worker.js',
		...
		self::MODE_CSS_LESS => 'mode\css\less_test.js',
		self::MODE_CSS_SCSS => 'mode\css\scss_test.js',
		...
		self::MODE_NGINX => 'mode\nginx\nginx.js',
		self::MODE_NTRIPLES	=> 'mode\ntriples\ntriples.js',
		...
		self::MODE_TCL => 'mode\tcl\tcl.js',
		self::MODE_TEXTILE => 'mode\textile\textile.js',
		self::MODE_TIDDLYWIKI => 'mode\tiddlywiki\tiddlywiki.js',
		self::MODE_TIKI	=> 'mode\tiki\tiki.js',
		self::MODE_TOML => 'mode\toml\toml.js',
		self::MODE_TORNADO	=> 'mode\tornado\tornado.js',
		self::MODE_TROFF => 'mode\troff\troff.js',
		self::MODE_TURTLE => 'mode\turtle\turtle.js',
